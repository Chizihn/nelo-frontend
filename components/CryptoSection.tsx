...
export default function CryptoSection() {
  return (
    <section className="bg-[#D8D8A399] px-4 sm:px-6 py-12 sm:py-20 md:py-32">
      <div className="max-w-6xl mx-auto flex flex-col gap-12 sm:gap-16 md:gap-20">
        {/* ORANGE CTA SECTION */}
        <div className="relative border-2 border-black bg-[#FFA64D] px-4 sm:px-8 md:px-16 py-10 sm:py-12 md:py-20 overflow-hidden">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16">
            {/* Left text */}
            <div className="max-w-lg">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bebas font-bold leading-tight mb-4 text-black uppercase">
                BUY CRYPTO EASILY ON <br /> WHATSAPP AT GREAT RATES
              </h2>
              <p className="text-base sm:text-lg text-black font-medium mb-6 sm:mb-8 font-space-grotesk leading-relaxed">
              ...
              <button className="px-4 sm:px-6 py-2 sm:py-3 bg-[#F4D9B0] border-2 border-black text-sm sm:text-base font-semibold font-orbitron hover:bg-[#F0C890] transition-colors">
                Chat on Whatsapp
              </button>
            </div>
            ...
            <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 shrink-0">
              ...
              <div className="absolute inset-6 sm:inset-8 border-4 border-black rounded-full bg-transparent"></div>
            </div>
          </div>

          {/* Overlap circle outside right edge */}
          <div className="absolute -right-20 -top-10 w-[240px] h-[240px] sm:w-[280px] sm:h-[280px] md:w-[320px] md:h-[320px] bg-[#FFD95C] border-4 border-black rounded-full hidden sm:block"></div>
          <div className="absolute -right-14 top-0 w-[240px] h-[240px] sm:w-[280px] sm:h-[280px] md:w-[320px] md:h-[320px] border-4 border-black rounded-full bg-transparent hidden sm:block"></div>
        </div>

        {/* BEIGE CTA SECTION */}
        <div className="relative border-2 border-black bg-[#F5F5DC] px-4 sm:px-8 md:px-16 py-10 sm:py-12 md:py-20 overflow-hidden">
          ...
          <div className="absolute -left-20 -top-10 w-[240px] h-[240px] sm:w-[280px] sm:h-[280px] md:w-[320px] md:h-[320px] bg-[#FFD95C] border-4 border-black rounded-full hidden sm:block"></div>
          <div className="absolute -left-14 top-0 w-[240px] h-[240px] sm:w-[280px] sm:h-[280px] md:w-[320px] md:h-[320px] border-4 border-black rounded-full bg-transparent hidden sm:block"></div>
        </div>
      </div>
    </section>
  );
